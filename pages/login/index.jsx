      ...
      <div className='flex'>
        ...
        <div className='flex-[3] md:pt-9 md:pr-16'>
          ...
          <div className='px-8 pt-8 md:p-16 md:pt-24 w-full md:w-[80%]'>
            <p className='text-2xl text-center md:text-[28px] md:text-left capitalize font-semibold'>Đăng nhập</p>
            <form className='mt-4' onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='flex justify-between items-center'>
                <button type='submit' className='text-sm md:text-base mt-5 w-[30%] bg-[#3577F0] py-4 rounded-md capitalize text-white font-semibold hover:scale-105 duration-300'>Đăng nhập</button>
                <Link href='/forget-password'>
                  <p className='text-[#3577F0] text-sm duration-300'>Quên mật khẩu?</p>
                </Link>
              </div>
            </form>
          </div>
