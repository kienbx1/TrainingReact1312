...
const NavBar = () => {
  ...
  return (
    <div className='hidden md:flex items-center gap-x-10'>
      ...
      >
        <div className={`font-bold capitalize cursor-pointer relative before:absolute before:-bottom-2 before:left-0 before:w-0 before:h-1 before:duration-500 before:bg-gradient-to-r before:from-gray-600 before:via-slate-400 before:to-zinc-500 ${name === 'all-items' ? 'before:w-full' : 'hover:before:w-full'}`}>
          Tất cả
        </div>
      </Link>
      <div className={`group relative flex flex-row gap-x-2 items-center font-bold capitalize cursor-pointer before:absolute before:-bottom-2 before:left-0 before:w-0 before:h-1 before:duration-500 before:bg-gradient-to-r before:from-gray-600 before:via-slate-400 before:to-zinc-500 ${(name === 'adidas' || name === 'nike' || name === 'converse') ? 'before:w-4/5' : 'hover:before:w-4/5'}`}>
        Thương hiệu
      ...
      >
        <div className={`font-bold capitalize cursor-pointer relative before:absolute before:-bottom-2 before:left-0 before:w-0 before:h-1 before:duration-500 before:bg-gradient-to-r before:from-gray-600 before:via-slate-400 before:to-zinc-500 ${name === 'sale-off' ? 'before:w-full' : 'hover:before:w-full'}`}>
          Sale off
        </div>
      </Link>
    </div>
